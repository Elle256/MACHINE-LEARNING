...
def parse_args():
    ...
    parser.add_argument("--partition", default="non_iid", choices=["iid", "non_iid", "dirichlet"],)
    parser.add_argument("--alpha", type=float, default=0.5, help="Dirichlet alpha (chỉ dùng khi partition=dirichlet)")
